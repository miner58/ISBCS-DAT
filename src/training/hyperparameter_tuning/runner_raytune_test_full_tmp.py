...
def main(experiment_path_list, test_data_default_path, data_config_path_dict, train_func, test_func, data_config_base_dir=None, data_type=None):
    ...
    for experiment_path in experiment_path_list:
        ...
        analyzer = EEGDARayTuneAnalyzer(config_path, os.path.join(experiment_path, 'dmmr_tune_raw5and6'), 
                                        train_func, test_func, test_data_default_path, data_config_path_dict)
        ...
        extract_max_acc_rows(os.path.join(experiment_path, 'analyzing_result','raw_test_results.csv'),
                os.path.join(experiment_path, 'analyzing_result'), group_cols=[], metric="test_micro_acc")
...
if __name__ == "__main__":
    ...
    data_config_base_dir = "/root/workspace/Fairness_for_generalization/src/config/data_config/raw3config/test/DMMR"
    ...
    # data_type = "wireless"
    # test_data_default_path = "/root/workspace/Fairness_for_generalization"
    # data_config_base_dir = "/root/workspace/Fairness_for_generalization/src/config/data_config/raw5and6config/test/DMMR"
    ...
    print(f"Filtered experiment paths: {experiment_path_list}")
    ...
    main(experiment_path_list, test_data_default_path, data_config_path_dict, train_func=DMMR_train_func, test_func=dmmr_test_func, data_config_base_dir=data_config_base_dir, data_type=data_type)
